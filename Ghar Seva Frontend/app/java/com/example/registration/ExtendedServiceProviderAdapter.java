...
public class ExtendedServiceProviderAdapter extends ArrayAdapter<ExtendedServiceProviderDetails> {
    private final Activity context;
    OnSwipeTouchListener onSwipeTouchListener;
    ArrayList<ExtendedServiceProviderDetails> listOfServiceProviders;

    TextView txtName,txtRating,txtAddress,txtDistanceAway;
    Button btnBook;
    ImageView imgVerified;
    NavController navController;
    String serviceType,location;

    public ExtendedServiceProviderAdapter(Activity context, ArrayList<ExtendedServiceProviderDetails> listOfServiceProviders,String serviceType,String location,NavController navController) {
        super(context, R.layout.showclosest_card,listOfServiceProviders);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ExtendedServiceProviderDetails serviceProvider = getItem(position);
        LayoutInflater inflater=context.getLayoutInflater();
        View rowView=inflater.inflate(R.layout.showclosest_card, null,true);
        ...
        float distanceInKms = serviceProvider.getDistance()/1000;
        distanceInKms = Float.parseFloat(String.format("%.3f", distanceInKms));
        txtDistanceAway.setText(distanceInKms+"kms away!");
