...
public class BookingModel {
	...
	public BookingModel(String serviceproviderName, String serviceProviderAddress, String serviceProviderType,
			String customerPhone, String customerAddress, String timeStamp) {
